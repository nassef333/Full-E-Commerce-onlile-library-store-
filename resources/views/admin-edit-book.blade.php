                        ...
                        <div class="iq-card">
                            ...
                            <div class="iq-card-body">
                                <form action='{{url("updateBook/$book->id")}}' method="POST" enctype="multipart/form-data">
                                    ...
                                    <option value="{{$book->category_id}}" selected="{{$book->category_id}}">{{$book->category_id}}</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img width="100px" height="100px" src='{{asset("storage/$book->img")}}' alt="">

                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" accept="image/png, image/jpeg" name="img" value="{{$book->img}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" accept="application/pdf, application/vnd.ms-excel" name="cdn" value="{{$book->cdn}}">
                                            <label class="custom-file-label">Choose file</label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="noPages" value="{{$book->noPages}}">
                                    </div>
                                    <div class="form-group">
