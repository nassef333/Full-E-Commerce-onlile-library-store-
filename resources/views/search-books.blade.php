                    ...
                    <ul id="iq-sidebar-toggle" class="iq-menu">
                        <li class="active active-menu">
                            ...
                            <ul id="dashboard" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">
                                ...
                                <li class="active"><a href="{{url('search-books')}}"><i class="ri-file-pdf-line"></i>Search</a></li>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="iq-card">
                            <div class="iq-card-header d-flex justify-content-between">
                                <h4 class="cd-title">Search For Books:</h4>
                            ...
                            <div class="iq-card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <section class=" cd-table-container">
                                        <input type="text" class="cd-search table-filter form-control" data-table="order-table" placeholder="Enter Book Data..">
                                        <br>
                                    <table class="cd-table order-table table data-tables table table-striped table-bordered" style="width:100%">
                                              ...
                                              <tbody>
                                                ...
                                                <tr style="display: table-row;">
                                                    ...
                                                    <td>${{$book->price}}</td>
                                                    <td><a href='{{url("book/$book->id")}}'><Button class="btn btn-primary">Book Here</Button></a></td>
                                                  </tr>
                                                @endforeach
                                              </tbody>
                                            </table>
