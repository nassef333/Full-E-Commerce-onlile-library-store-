                    ...
                    <ul id="iq-sidebar-toggle" class="iq-menu">
                        ...
                        <li class="active active-menu">
                            ...
                            <ul id="admin" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">
                                ...
                                <li class="active"><a href="{{url('admin-category')}}"><i class="ri-function-line"></i>Books Category</a></li>
                                <li><a href="{{url('admin-books')}}"><i class="ri-file-pdf-line"></i>Books</a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
                        ...
                        <div class="iq-card">
                            ...
                            <div class="iq-card-body">
                                <form action='{{url("updateCategory/$category->id")}}' method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label>Image:</label>
                                        <img style="max-width:300px; max-heigh:300px" src='{{asset("storage/$category->img")}}' alt=""><br><br>
