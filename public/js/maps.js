...
am4internal_webpackJsonp(["cc1e"], {
    QJ7E: function(t, e, n) {
        ...
        var mt, yt, bt, Pt, St, _t, Mt, xt, jt, Ot, wt = m(),
            Lt = {
                point: Ct,
                lineStart: It,
                lineEnd: Tt,
        ...
        var At, Rt, kt, Bt, Wt, Ht, Zt, qt, Xt, Yt, Ut, Jt, Kt, Qt, $t, te, ee = function(t) {
                ...
                if (Pt = bt = -(mt = yt = 1 / 0), jt = [], et(t, Lt), n = jt.length) {
                    for (jt.sort(Ft), e = 1, o = [i = jt[0]]; e < n; ++e) Vt(i, (r = jt[e])[0]) || Vt(i, r[1]) ? (zt(i[0], r[1]) > zt(i[0], i[1]) && (i[1] = r[1]), zt(r[0], i[1]) > zt(i[0], i[1]) && (i[0] = r[0])) : o.push(i = r);
                    for (a = -1 / 0, e = 0, i = o[n = o.length - 1]; e <= n; i = r, ++e) r = o[e], (u = zt(i[1], r[0])) > a && (a = u, mt = r[0], bt = i[1])
                }
                return jt = Ot = null, mt === 1 / 0 || yt === 1 / 0 ? [
                    [NaN, NaN],
                    [NaN, NaN]
                ] : [
                    [mt, yt],
        ...
        var fe = function(t) {
                ...
                var e = Xt,
                    ...
                    i = Ut,
                    r = e * e + n * n + i * i;
                return r < _ && (e = Ht, n = Zt, i = qt, Rt < S && (e = kt, n = Bt, i = Wt), (r = e * e + n * n + i * i) < _) ? [NaN, NaN] : [I(n, e) * w, B(i / A(r)) * w]
            },
            de = function(t) {
                return function() {
                    return t
        ...
        var Te = function(t, e) {
                ...
                for (var s = 0, c = t.length; s < c; ++s)
                    if (h = (l = t[s]).length)
                        for (var l, h, p = l[h - 1], f = Ie(p), d = p[1] / 2 + j, g = F(d), v = T(d), m = 0; m < h; ++m, f = b, g = _, v = w, p = y) {
                            var y = l[m],
                                b = Ie(y),
                                P = y[1] / 2 + j,
                                _ = F(P),
        ...
        var Ne = Array.prototype,
            ze = (Ne.slice, Ne.map, function(t, e, n) {
        ...
        var ke = Ve(function() {
            ...
            var r;
            if (null == t) r = n * x, i.point(-M, r), i.point(0, r), i.point(M, r), i.point(M, 0), i.point(M, -r), i.point(0, -r), i.point(-M, -r), i.point(-M, 0), i.point(-M, r);
            else if (C(t[0] - e[0]) > S) {
                var o = t[0] < e[0] ? M : -M;
                ...
                return Ve(o, function(t) {
                    ...
                    return {
                        ...
                        point: function(h, p) {
                            ...
                            if (!e && (c = s = g) && t.lineStart(), g !== s && (!(f = a(e, d)) || Oe(e, f) || Oe(d, f)) && (d[0] += S, d[1] += S, g = o(d[0], d[1])), g !== s) l = 0, g ? (t.lineStart(), f = a(d, e), t.point(f[0], f[1])) : (f = a(e, d), t.point(f[0], f[1]), t.lineEnd()), e = f;
                            else if (r && e && i ^ g) {
                                var m;
        ...
        function Fi(t) {
            ...
            return j.stream = function(t) {
                    ...
                    return arguments.length ? (M = null == t ? (_ = i = r = o = null, jn) : qe(_ = +t[0][0], i = +t[0][1], r = +t[1][0], o = +t[1][1]), E()) : null == _ ? null : [
                        [_, i],
                        [r, o]
                    ]
                }, j.scale = function(t) {
        ...
        var gr = function() {
            ...
            return o = {
                ...
                clipExtent: function(i) {
                    return arguments.length ? (f = null == i ? (p = t = e = n = null, jn) : qe(p = +i[0][0], t = +i[0][1], e = +i[1][0], n = +i[1][1]), d()) : null == p ? null : [
                        [p, t],
                        [e, n]
                    ]
                },
        ...
        var Do = Math.abs,
            ...
            Bo = Math.min,
            Wo = Math.pow,
            Ho = (Math.round, Math.sign || function(t) {
                return t > 0 ? 1 : t < 0 ? -1 : 0
            }),
            Zo = Math.sin,
            qo = Math.tan,
        ...
        Ha.invert = function(t, e) {
            var n = ($o - 1) / ($o + 1),
                ...
                r = function(t, e, n) {
                    var i, r, o;
                    return t ? (i = Ba(t, n), e ? (o = (r = Ba(e, 1 - n))[1] * r[1] + n * i[0] * i[0] * r[0] * r[0], [
