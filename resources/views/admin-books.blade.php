                                ...
                                <div class="table-responsive">
                                    <table class="data-tables table table-striped table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{$book->id}}</td>
                                                <td><img class="img-fluid rounded" src='{{asset("storage/$book->img")}}' alt=""></td>
                                                <td>{{$book->name}}</td>
                                                ...
                                                <td>${{$book->price}}</td>
                                                <td><a href='{{url("book/$book->id")}}'><Button class="btn btn-primary">{{$book->id}}</Button></a></td>
                                                <td>
                                                    <div class="flex align-items-center list-user-action">
                                                        <a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href='{{url("editBook/$book->id")}}'><i class="ri-pencil-line"></i></a>
                                                        <a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete" href='{{url("deleteBook/$book->id")}}'><i class="ri-delete-bin-line"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                            @endforeach
